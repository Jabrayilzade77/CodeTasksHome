    ...
    <>
      ...
      <section className="samplepost_hero">
        <div className="post_heading">
          <h1 className="post_h1">
            Man must explore, and this is exploration at its greatest
          </h1>
          <h2 className="subheading">
            Problems look mighty small from 150 miles up
          </h2>
          <span className="meta_post">
            <Link to={"/"} className="samplea">
              Start Bootstrap
            </Link>
      ...
      <section className="sample_container">
        <div className="container">
          ...
          <div>
            <p className="reaching" style={{ fontSize: "36px" }}>
              The Final Frontier
            </p>
            <p>
      ...
      <section className="sample_section">
        <div className="text_container">
          ...
          <div className="text_sample_p">
            <img
              src="https://startbootstrap.github.io/startbootstrap-clean-blog/assets/img/post-sample-image.jpg"
              alt=""
              className="img_kosmonaft"
            ></img>
            <p className="sample_pp" style={{ color: "#6c757d" }}>
      ...
      <section className="text_container_2">
        <div className="container_text">
          ...
          <p>
            Placeholder text by <Link to={"/"}>Space Ipsum</Link> · Images by{" "}
            <Link to={"/"}>NASA on The Commons</Link>
          </p>
        </div>
      </section>
    </>
